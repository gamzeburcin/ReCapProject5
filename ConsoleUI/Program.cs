...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    carManager.Update(new Car { CarId = 2004, BrandId = 2002, ColorId = 1002, DailyPrice = 200, ModelYear = 2012, Description = "Fiat 500 Star" });

            //    carManager.Delete(new Car { CarId = 2004, BrandId = 2002, ColorId = 1002, DailyPrice = 200, ModelYear = 2012, Description = "Fiat 500 Star" });
            ...
            //    Console.WriteLine(carTemp.CarId + " " + carTemp.BrandId + " " +
